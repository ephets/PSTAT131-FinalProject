...
The last variable whose performance we will be exploring is `released_year`. How did the prediction accuracy of our model change depending on when a movie was released? 
...
We wanted to build a model that could predict the gross revenue of a movie with some accuracy given the film's release year, runtime, director, main actor, IMDb rating, and the number of votes it received on the IMDb website. 
